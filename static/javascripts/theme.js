...
$(document).ready(function(){
  ...
  var addChartsAlert = function(selector) {
    var str = {
      'es': 'Los datos de ejecución del año 2016 son provisionales y están pendientes del cierre de ejercicio. Los datos de 2017 están actualizados a 12 de junio.',
      'gl': 'Os datos de execución do ano 2016 son provisionais e están pendentes do peche de exercicio. Os datos de 2017 están actualizados ao 12 de xuño.'
    };
    var cont = $(selector);
    if (cont.size() > 0) {
